...
from core.execution import LiveExecutionAdapter
...
def main() -> None:
    ...
    print(
        f"[LIVE] symbol={SYMBOL} strategies={len(strategies)} "
    ...
    try:
        ...
        print(f"[LIVE] anchor={anchor.isoformat()}")
        print(f"[LIVE] cleanup={seeder.cleanup_pre_anchor(anchor)}")
